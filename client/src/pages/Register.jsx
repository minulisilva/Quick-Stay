...
const Register = () => {
    ...
    return (
        <div className="min-h-screen flex bg-white">
            {/* Right Side (Image on Right for Register to alternate) -> actually standard Left Form / Right Image is good for consistency, let's keep it or flip it? 
               Let's Flip it for variety. Image Left, Form Right.
            */}
            ...
            <div className="hidden lg:block w-1/2 relative bg-gray-900 overflow-hidden">
                ...
                <div className="absolute bottom-20 left-12 right-12 text-white">
                    ...
                    >
                        <h2 className="text-5xl font-serif mb-6 leading-tight">"Join our exclusive club of distinguished guests."</h2>
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-1 bg-primary rounded-full"></div>
                            <p className="font-light tracking-wider uppercase">Member Benefits</p>
                        </div>
                    </motion.div>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-24 relative z-10">
                <div className="w-full max-w-md">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-5xl font-serif text-secondary mb-3">Create Account</h1>
                        <p className="text-gray-500 mb-10 text-lg">Begin your journey with QuickStay today.</p>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="space-y-2">
                                <label className="text-xs uppercase tracking-wider font-bold text-gray-900">Full Name</label>
